...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	@rm -rf $(dir $@)
	@mkdir -p $(dir $@)
	$(hide) tar xfp vendor/sprit/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	cat vendor/sprit/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
