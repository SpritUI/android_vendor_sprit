...
ALARM_PATH := vendor/sprit/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/sprit/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/sprit/prebuilt/common/media/audio/ringtones
